...
if gen_predictions:
    ...
    if sqft>1000:
        predicted_price_sqft = (sqft-500)*662 - bed*458430 + bath*971200
    ...
    if bed>1:
        predicted_price_bed = sqft*662 - (bed-1)*458430 + bath*971200
    ...
    if bath>1:
        predicted_price_bath = sqft*662 - bed*458430 + (bath-1)*971200
